...
if (isset($_POST['DeptID'])) {
    ...
    if (isset($_POST['StartDate'])) {
        ...
        $stmt = "SELECT FacultyName,Date, SUM(CASE WHEN TypeOfLeaveID =1 THEN 1 ELSE 0 END) +  
                                            ...
                                            FROM  facultyleaveallocation INNER JOIN facultyinfo ON facultyleaveallocation.FacultyInfoID=facultyinfo.FacultyInfoID  WHERE facultyleaveallocation.DeptID=$DeptID AND Date BETWEEN '" . $StartDate . "' AND '" . $EndDate . "' GROUP BY facultyleaveallocation.FacultyInfoID ";
