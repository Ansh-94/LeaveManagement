...
if (isset($_POST['DeptID'])) {
  ...
  if (isset($_POST['Year'])) {
    ...
    $stmt = "SELECT FacultyName,EXTRACT(YEAR FROM Date) AS Date, SUM(CASE WHEN TypeOfLeaveID =1 THEN 1 ELSE 0 END) +  
                                            ...
                                            SUM(CASE WHEN TypeOfLeaveID =1 THEN 1 ELSE 0 END) +  
                                            SUM(CASE WHEN TypeOfLeaveID =3 THEN 1 ELSE 0 END) / 2+  SUM(CASE WHEN TypeOfLeaveID =2 THEN 1 ELSE 0 END)+ SUM(CASE WHEN TypeOfLeaveID =4 THEN 1 ELSE 0 END)+ SUM(CASE WHEN TypeOfLeaveID =5 THEN 1 ELSE 0 END)+ SUM(CASE WHEN TypeOfLeaveID =6 THEN 1 ELSE 0 END)+SUM(CASE WHEN TypeOfLeaveID =7 THEN 1 ELSE 0 END)+ SUM(CASE WHEN TypeOfLeaveID =8 THEN 1 ELSE 0 END) + SUM(CASE WHEN TypeOfLeaveID =9 THEN 1 ELSE 0 END) + SUM(CASE WHEN TypeOfLeaveID =10 THEN 1 ELSE 0 END) AS Total
